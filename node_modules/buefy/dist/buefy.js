...
(function (global, factory) {
  ...
  var script$M = {
    name: 'BSlider',
    components: (_components$6 = {}, _defineProperty(_components$6, __vue_component__$K.name, __vue_component__$K), _defineProperty(_components$6, __vue_component__$L.name, __vue_component__$L), _components$6),
    props: {
      value: {
        type: [Number, Array],
        default: 0
  ...
  var script$T = {
    name: 'BTable',
    components: (_components$9 = {}, _defineProperty(_components$9, __vue_component__$7.name, __vue_component__$7), _defineProperty(_components$9, __vue_component__.name, __vue_component__), _defineProperty(_components$9, __vue_component__$1.name, __vue_component__$1), _defineProperty(_components$9, __vue_component__$C.name, __vue_component__$C), _defineProperty(_components$9, SlotComponent.name, SlotComponent), _defineProperty(_components$9, __vue_component__$R.name, __vue_component__$R), _defineProperty(_components$9, __vue_component__$S.name, __vue_component__$S), _components$9),
    props: {
      data: {
        type: Array,
        default: function _default() {
  ...
  var script$Y = {
    name: 'BTaginput',
    components: (_components$b = {}, _defineProperty(_components$b, __vue_component__$2.name, __vue_component__$2), _defineProperty(_components$b, __vue_component__$W.name, __vue_component__$W), _components$b),
    mixins: [FormElementMixin],
    inheritAttrs: false,
    props: {
      value: {
  ...
  /* template */
  var __vue_render__$T = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('label',{staticClass:"upload control"},[(!_vm.dragDrop)?[_vm._t("default")]:_c('div',{staticClass:"upload-draggable",class:[_vm.type, {
                  'is-loading': _vm.loading,
                  'is-disabled': _vm.disabled,
  ...
  var __vue_staticRenderFns__$T = [];
    ...
    const __vue_component__$_ = normalizeComponent_1(
      { render: __vue_render__$T, staticRenderFns: __vue_staticRenderFns__$T },
