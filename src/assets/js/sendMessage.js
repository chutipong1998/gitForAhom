const LINE_LIFF_ID = '1654119168-oE6Wj9bn' // real
// const LINE_LIFF_ID = '1654123386-yz6pE61E' // test
var nameCustomer = ''

// Init Line LIFF
function sendMessage (liff, counter, total, categories, shopName, shipping) {
  liff
    .init({
      liffId: LINE_LIFF_ID
    })
                ...
                items.push(
                  {
                    ...
                    'contents': [
                      ...
                      {
                        'type': 'text',
                        'text': (categories[i].menus[j].price * counter[i][j]).toString(),
                        'size': 'sm',
                        'align': 'end',
                        'color': '#AAAAAA'
                      }
